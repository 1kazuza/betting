...
def results():
    ...
    if (diff_odds > 0):
        ...
        print(colored(txt3.center(50), "green"))
    elif (diff_odds == 0):
        txt4 = "Null Expected Value: {:.2f}% (breakeven)".format(profit) 
        print(colored(txt4.center(50), "yellow"))
    else:
        txt5 = "Negative Expected Value: {:.2f}% (loss)".format(profit) 
        print(colored(txt5.center(50), "red"))  
...
while True:
    ...
    try:
        ...
        print(intro)
        print("=" * 60)
        print("Use decimal point (.) instead of decimal comma (,)".center(60))
        print("=" * 60)
        ...
        if (question == "n"):
            print("-" * 50)
            print("Finished... Good luck!".center(50))
            print("-" * 50)
            exit()                
        elif (question != "y"):
            print("=" * 74)    
            print("Type 'y' for YES or 'n' for NO (in the last question)...".center(74))
            print("=" * 74)    
            question = str(input("Want to continue? [y,n]: ")).lower()
            if (question == "n"):
                print("-" * 50)
